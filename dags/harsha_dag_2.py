...
with DAG('load_data_to_snowflake',
    ...
    github_file_url = 'https://github.com/mukkellaharsha/harsha.repo/main/data_table.csv'
    ...
    def upload_csv_to_snowflake():
        ...
        file_path = 'https://github.com/mukkellaharsha/harsha.repo/main/data_table.csv'
